...
--> Specimen/Accession/AccessionNumber (als decisive markiert, mit Pre.: SLA- (für Soundlabor))  
--> Part 1/AccessionNumber (als decisive markiert, mit Pre.: SLA-)  
...
--> Specimen/Accession/AccessionNumber (addiert, mit Pre.: -)  
--> Part 1/AccessionNumber (addiert, mit Pre.: -)  
--> Part 1/Notes (nicht decisive, mit Pre.: "take no.:" + Leerzeichen, mit Post: Leerzeichen + ; + Leerzeichen)  

          Format für AccessionNumber: SLA-001-003  (SLA- tape no. - take no.)
...
--> Part 1/Notes (nicht decisive, mit Pre.: take start: + Leerzeichen, mit Post: Leerzeichen + ; + Leerzeichen)  
...
--> Part 1/Notes (nicht decisive, mit Pre.: take stop: + Leerzeichen)  
...
-  Project 1: ProjectID: "For all: Amibio oder ZFMK-Test" (als decisive markiert)  
